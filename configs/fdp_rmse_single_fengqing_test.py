"""fdp 确定性场检验 — 本地测试数据版（D:/fdp_weather_test_bash）。
...
CONFIG = {
    ...
    "model_data_root": "D:/fdp_weather_test_bash/FCSTDATA",
    "cra_root": "D:/fdp_weather_test_bash/cra_root",
    "cli_root": "D:/fdp_weather_test_bash/CLI_6HOUR",  # 不存在 → ACC 自动跳过
    "surface_only": False,
    "pressure_only": False,
    "resume": True,
    "output_dir": "D:/xmetai-evalation/outputs/results/fdp_rmse_single_fengqing_test",
}
