...
输出：outputs/.temp/fdp_activity_spectrum/ → outputs/results/ 下两个长表：
fdp_activity_spectrum.csv（活跃度）+ fdp_activity_spectrum_power_spectrum.csv。
"""
CONFIG = {
    "capability": "fdp_activity_spectrum",
    "output_name": "fdp_activity_spectrum",
    ...
    "resume": True,
    "output_dir": "/workspace/szwCode/xmetai-eval_pro/outputs/results/fdp_activity_spectrum",
}
