"""Single FGVP deterministic evaluation config.

Migrated from scripts/single_fgvp.sh.
"""
...
CONFIG = {
    "type": "batch",
    "label": "fgvp",
    "output_name": "weather_rmse_single_fgvp",
    "pred_root": "/workspace/data/shenzw/fgvp_output",
    "target_zarr": [
