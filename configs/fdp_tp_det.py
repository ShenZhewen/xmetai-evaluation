...
输出：outputs/.temp/fdp_tp_det/ → outputs/results/fdp_tp_det/fdp_tp_det.csv
长表（6h/24h 两个文件合并，accum_hours 列区分）。
"""
CONFIG = {
    "capability": "fdp_tp_det",
    "output_name": "fdp_tp_det",
    ...
    "resume": True,
    "output_dir": "/workspace/szwCode/xmetai-eval_pro/outputs/results/fdp_tp_det",
}
