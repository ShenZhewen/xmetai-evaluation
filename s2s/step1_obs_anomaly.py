...
CLIM_OUTPUT_DIR    = Path(f"/gpu/zhouchg/liuzh/step1_output/CRA_1.5/clim_1p5/{VAR_NAME}")
DIFF_OUTPUT_DIR    = Path(f"/gpu/zhouchg/liuzh/step1_output/CRA_1.5/diff_1p5/{VAR_NAME}")
INTERP_OUTPUT_DIR  = Path(f"/gpu/zhouchg/liuzh/step1_output/CRA_1.5/anom_1p5/{VAR_NAME}")
COMBINE_OUTPUT_DIR = Path(f"/gpu/zhouchg/liuzh/step1_output/CRA_1.5/anom_combine_1p5/{VAR_NAME}")
